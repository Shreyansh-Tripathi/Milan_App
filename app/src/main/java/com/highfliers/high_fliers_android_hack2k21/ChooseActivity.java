...
import com.highfliers.high_fliers_android_hack2k21.AnonymousSection.AnonymousCall;
import com.highfliers.high_fliers_android_hack2k21.InterestSection.InterestDetailsAdapter;
import com.highfliers.high_fliers_android_hack2k21.InterestSection.RoomAdapter;
        ...
        RoomAdapter.ItemClick, RestrictedRoomAdapter.ItemClick
{
    ...
    public void fromMic(SpeechConfig speechConfig) throws InterruptedException, ExecutionException {
        ...
        if(result.getText().contains("***"))
        {
            ...
            startActivity(new Intent(this, CreateRestrictedActivity.class));
